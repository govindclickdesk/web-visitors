...
/**
 * An instance of this class can be used to prepopulate properties (event or
 * channel name) with default values
 * 
...
public class PusherRequest
{
	...
	/**
	 * Create an instance and assign both channelName and eventName that are
