 ...
 */
package com.livily.pusher.main.java.ch.mbae.pusher;

import java.net.URL;

/**
 * Interface to encapsulate doing the http transport by a given http transport
 * implementation as GAE URLFetchService, Jakarta Commons HttpClient or whatever
 * ever.
 */
